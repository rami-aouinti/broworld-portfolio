...
class ProjectControllerTest extends WebTestCase
{
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'project[gitLink]' => 'Something New',
            'project[reference]' => 'Something New',
            'project[skills]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getGitLink());
